...
//      def mvnHome = tool name: 'maven', type: maven
    ...
    stage ('Deploy to Test') {
      steps {
        ...
        jiraSendDeploymentInfo environmentId: 'Test', environmentName: 'Test', environmentType: 'testing', serviceIds: ['http://40.87.91.214:8080/QAWebapp'], site: 'devops-bootcamp.atlassian.net', state: 'successful'
      }
    }
    stage ('Artifact') {
      steps {
    ...
    stage ('Deploy to Prod') {
      steps {
        ...
        jiraSendDeploymentInfo environmentId: 'Prod', environmentName: 'Prod', environmentType: 'production', serviceIds: ['http://40.71.27.26:8080/ProdWebapp'], site: 'devops-bootcamp.atlassian.net', state: 'successful'
      }
    }
